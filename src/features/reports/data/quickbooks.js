...
export const QB_REPORTS_BY_CAT = {
  ...
  purchases: [
    ...
    { name: '1099 Contractor Balance Summary',                                desc: 'Amounts paid to 1099 contractors (US).' },
    { name: '1099 Transaction Detail Report',                                 desc: 'Line-level 1099 contractor transactions (US).' },
