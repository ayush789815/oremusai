// Unified Zoho Books report catalog — the curated report set only.
...
export const ZOHO_REPORTS_BY_CAT = {
  ...
  purchases: [
    ...
    { name: 'Expenses by Category',               liveType: 'expensedetails', fav: true, desc: 'Total spend grouped by expense account.' },
